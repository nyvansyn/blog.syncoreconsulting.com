...
namespace Sky_Addons\Modules\NaiveList\Widgets;
...
class Naive_List extends Widget_Base
{
    ...
    {
        return 'sky-naive-list';
    }

    public function get_title()
    {
        return esc_html__('Naive List', 'sky-elementor-addons');
    }

    public function get_icon()
    {
        return 'sky-icon-naive-list';
    }
    ...
    {
        return ['sky', 'post', 'blogs', 'bloggers', 'naive', 'list'];
    }
...
?>
    ...
    ?>
        <div <?php echo $this->get_render_attribute_string('naive-list'); ?>>
            <?php
